...
from apps.ops_nginx.models import NginxConf, NginxAction, NginxInstanceOps
from libs.ansible_hepler import my_runner
from libs.dns_query.query_dns import DnsQuery
    ...
    try:
        ...
        if confObj.conf_add_status != True and confObj.type.nginx_type == 'consul':
            ...
            if code == 0:
                ...
                wxData['action'] = "创建dump文件错误"
                wxData['msg'] = "创建dump文件失败!!!"
                sendMessage(**wxData)
